#ifndef __FERRIS_GAME__FerrisMotionStreak__
#define __FERRIS_GAME__FerrisMotionStreak__
 ...
 */
class FerrisMotionStreak : public CCNodeRGBA, public CCTextureProtocol
#ifdef EMSCRIPTEN
...
public:
    FerrisMotionStreak();
    virtual ~FerrisMotionStreak();

    /** creates and initializes a motion streak with fade in seconds, minimum segments, stroke's width, color, texture filename */
    static FerrisMotionStreak* create(float fade, float minSeg, float stroke, ccColor3B color, const char* path);
    /** creates and initializes a motion streak with fade in seconds, minimum segments, stroke's width, color, texture */
    static FerrisMotionStreak* create(float fade, float minSeg, float stroke, ccColor3B color, CCTexture2D* texture);
