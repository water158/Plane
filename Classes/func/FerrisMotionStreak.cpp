...
FerrisMotionStreak::FerrisMotionStreak()
	: m_bFastMode(false)
...
FerrisMotionStreak* FerrisMotionStreak::create(float fade, float minSeg, float stroke, ccColor3B color, const char* path)
{
	FerrisMotionStreak *pRet = new FerrisMotionStreak();
...
FerrisMotionStreak* FerrisMotionStreak::create(float fade, float minSeg, float stroke, ccColor3B color, CCTexture2D* texture)
{
	FerrisMotionStreak *pRet = new FerrisMotionStreak();
...
bool FerrisMotionStreak::initWithFade(float fade, float minSeg, float stroke, ccColor3B color, const char* path)
{
...
bool FerrisMotionStreak::initWithFade(float fade, float minSeg, float stroke, ccColor3B color, CCTexture2D* texture)
{
...
void FerrisMotionStreak::setPosition(const CCPoint& position)
{
	m_bStartingPositionInitialized = true;
	m_tPositionR = position;
}

void FerrisMotionStreak::tintWithColor(ccColor3B colors)
{
	setColor(colors);
...
CCTexture2D* FerrisMotionStreak::getTexture(void)
{
	return m_pTexture;
}

void FerrisMotionStreak::setTexture(CCTexture2D *texture)
{
...
void FerrisMotionStreak::setBlendFunc(ccBlendFunc blendFunc)
{
	m_tBlendFunc = blendFunc;
}

ccBlendFunc FerrisMotionStreak::getBlendFunc(void)
{
	return m_tBlendFunc;
}

void FerrisMotionStreak::setOpacity(GLubyte opacity)
{
	CCAssert(false, "Set opacity no supported");
}

GLubyte FerrisMotionStreak::getOpacity(void)
{
	CCAssert(false, "Opacity no supported");
	return 0;
}

void FerrisMotionStreak::setOpacityModifyRGB(bool bValue)
{
	CC_UNUSED_PARAM(bValue);
}

bool FerrisMotionStreak::isOpacityModifyRGB(void)
{
	return false;
}

void FerrisMotionStreak::update(float delta)
{
...
void FerrisMotionStreak::reset()
{
	m_uNuPoints = 0;
}

void FerrisMotionStreak::draw()
{
	if(m_uNuPoints <= 1)
		return;
